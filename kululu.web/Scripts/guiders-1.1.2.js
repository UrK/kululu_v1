...
var guiders = (function ($) {
    var guiders = {
      ...
      "    <div class='guider_buttons group'>",
      "    </div>",
      "  </div>",
      ...
      "</div>"
        ...
        _arrowSize: 15, // = arrow's width and height
        _guiders: {},
        ...
        _addButtons: function (myGuider) {
            ...
            if (myGuider.buttons.length == 0) {
                $(guiderButtonsContainer).css('display', 'none');
                return;
            };
        ...
        */
        ...
        createGuider: function (passedSettings) {
            ...
            if (myGuider.title.length > 0) {
                ...
                guiderElement.find("h1.guider_title").css('display', 'none');
            };
